    ...
    <CardWrapper title="User Profile">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-gray-900 dark:text-gray-50">{profile.first_name}</p>
        </div>
        <div>
          <Label className="text-sm font-medium text-gray-500 dark:text-gray-400">Middle Initial</Label>
          <p className="text-gray-900 dark:text-gray-50">{profile.middle_initial}</p>
        </div>
        <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p className="text-gray-900 dark:text-gray-50">{profile.contact_number}</p>
        </div>
      </div>
    </CardWrapper>
  );
